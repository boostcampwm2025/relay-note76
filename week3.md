...
**입력 프롬프트**
내 상황에 맞게 5분 안에 실천할 수 있는 활동 하나를 추천해줘.
문제 상황: 5일 동안 하루에 4시간씩밖에 못 자서 너무 피곤한데, 아침에 정신을 차리고 회의에 들어가야 해.
활동 목적: 잠을 깨우고 싶어.
추천 기준: 실내에서 할 수 있는 것이었으면 좋겠어.
...
1. 자리에서 일어나기 (10초)
등을 쫙 펴고, 가볍게 한숨 크게 쉬면서 자리에서 일어나세요.
...
2. 전신 스트레칭 (2분)
	...
	•	무릎 굽힌 채 허리 숙이기: 30초
	•	허리 비틀기 & 옆구리 늘리기: 30초
	•	가벼운 제자리 점프 or 뛰기: 30초

3. 화장실 가서 찬물로 세수 (1분)
	•	손과 얼굴에 차가운 물을 팍팍!
	•	손목, 목덜미까지 찬물로 적시면 효과 2배!

4. 창문 열고(가능하면) 신선한 공기 들이마시기 (1분)
	•	10초간 숨을 깊게 들이마시고 내쉬세요.

5. 짧게 눈 감고 심호흡 (30초)
	•	‘나는 깨어난다, 상쾌하다’ 라고 자기암시까지!

⸻

✅ 이유와 효과
	•	전신 스트레칭과 가벼운 운동은 뇌에 산소와 혈액을 보내 즉시 잠이 달아나게 도와줍니다.
	•	찬물 세수는 심신을 깨우고, 혈액순환을 촉진해줍니다.
	•	짧은 심호흡과 신선한 공기는 의식 전환에 탁월합니다.
